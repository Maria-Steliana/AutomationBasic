...
public class WebTablePage extends BasePage {
    ...
    public int getTableSize() {
        ...
        logInfo(INFO_STEP, "Get initial table size -> Inital table size is: " + initialTableSize);
    ...
    public void clickToAddNewRecord() {
        logInfo(INFO_STEP, "User clicked on add new record button.");
    ...
    public void fillFormValues(Map<String, Object> webTableEntryData) {
        ...
        logInfo(INFO_STEP, "Last name value: " + (String)webTableEntryData.get("lasttName"));
